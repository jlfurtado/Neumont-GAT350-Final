...
layout(location = 36) uniform vec3 rowColor;
layout(location = 37) uniform vec3 columnColor;
...
void main()
{
	...
	float t = x/(1.0f*numRows) + y/(1.0f*numColumns);
	fColor = rowColor * t + columnColor * (1.0f - t);
}